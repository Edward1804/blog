        ...
        <div id="templatemo_main">
            ...
            <div id="templatemo_content">
                ...
                <div class="post_box">
                    ...
                    <div class="news_meta">Posted on <a href="#"><?php echo $newsItem['author'];?></a>, <?php echo $newsItem['date'];?> | Tags: <a href="#">Blog</a>, <a href="#">Templates</a>, <a href="#">Design</a>, <a href="#">Free</a></div>
                    <div class="image_wrapper"><a href="news/<?php echo $newsItem['id'];?>" target="_parent"><img src="<?php echo $newsItem['preview'];?>" alt="image 1" /></a></div>
                    <p align="justify">
                        <?php echo $newsItem['short_content'];?><a href="news/<?php echo $newsItem['id'];?>" class="continue"> Continue ...</a>
                    </p>
                    <div class="cleaner"></div>
                </div>
                <?php endforeach;?>
            ...
            <div id="templatemo_sidebar">
                ...
                <div id="aboutus">
                    ...
                    <div class="image_fl"><img src="/templates/images/templatemo_about.jpg" alt="about this blog" /></div>
                ...
                <div class="sidebar_box">
                    ...
                    <div class="ads_125"><a href="http://www.templatemo.com/page/1" target="_parent"><img src="/templates/images/ads_125.jpg" alt="ad 1" /></a></div>
                    <div class="ads_125 odd"><a href="http://www.templatemo.com/page/2" target="_parent"><img src="/templates/images/ads_125.jpg" alt="ad 2" /></a></div>

                    <div class="ads_125"><a href="http://www.templatemo.com/page/3" target="_parent"><img src="/templates/images/ads_125.jpg" alt="ad 3" /></a></div>
                    <div class="ads_125 odd"><a href="http://www.templatemo.com/page/4" target="_parent"><img src="/templates/images/ads_125.jpg" alt="ad 4" /></a></div>
                ...
                <div class="sidebar_box">
                    ...
                    <div class="cleaner_h20"></div>
                    <a href="#" class="icon_link"><img src="/templates/images/templatemo_rss.jpg" alt="rss" /></a><a href="#" class="icon_link"><img src="/templates/images/templatemo_twitter.jpg" alt="twitter" /></a>
                </div>
